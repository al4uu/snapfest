...
<p>SnapFest is a performance module designed specifically for Snapdragon devices, the successor of ??. This module focuses on boosting speed, responsiveness, and overall device performance, making daily use and gaming smoother.</p>

## 📑 Notes
- Do a `Clean Flash` of this `module` if you're on a version below `2.0`.
- This `module` hasn’t been [**Bumbu Racik**](https://github.com/al4uu/bumbu_racik.git) based since version 1.2
